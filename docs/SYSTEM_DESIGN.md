...
> ⚠️ **All data in SimZoner is mock/synthetic.** See `SIMULATION_RULES.md` §0. Nothing this system
> produces is a claim about any real vehicle on any real road.
...
```
  ...
  ║  NO network. NO LLM. NO clock.    ║  Runs BETWEEN ticks, never inside.   ║
...
replays the seed and reaches tick 8,412 exactly — in the browser, for free.
